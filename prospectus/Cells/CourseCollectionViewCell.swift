...
class CourseCollectionViewCell: UICollectionViewCell {
    ...
    func setupViewContraints() {
        ...
        // courseView
        courseView.topAnchor.constraint(equalTo: self.contentView.topAnchor, constant: 8).isActive = true
        courseView.leftAnchor.constraint(equalTo: self.contentView.leftAnchor, constant: 8).isActive = true
        courseView.rightAnchor.constraint(equalTo: self.contentView.rightAnchor, constant: -8).isActive = true
        courseView.bottomAnchor.constraint(equalTo: self.contentView.bottomAnchor, constant: -8).isActive = true
