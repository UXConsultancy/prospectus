...
//    let newsTabBarItem:UITabBarItem = UITabBarItem(title: "News", image: UIImage(named: "news_dark"), selectedImage: UIImage(named: "news_light"))
    ...
    let welcomeTabBarItem:UITabBarItem = UITabBarItem(title: "News", image: UIImage(named: "news_dark"), selectedImage: UIImage(named: "news_light"))
...
//        newsViewController.tabBarItem = newsTabBarItem
        ...
        let viewControllerList = [welcomeViewController, coursesViewController, favouritesViewControllers ]
