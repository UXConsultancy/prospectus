...
class DetailView: UIView {
    ...
    fileprivate func setupViews() {
        ...
        // dateView
        dateView.topAnchor.constraint(equalTo: imageView.bottomAnchor, constant: 12).isActive = true
...
//        textView.heightAnchor.constraint(greaterThanOrEqualTo: self.heightAnchor, constant: 12).isActive = true
    }
